...
public class PublisherLinkTest {
    ...
    static void initializeFields() {
        System.out.println("\nRunning " + PublisherLinkTest.class.getSimpleName() + "...");
    ...
    @Test
    @Order(3)
    @DisplayName("Hover over the 'Publisher' link")
    void hoverOverPublisherLink() {
        // Act
        try {
            element = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Publisher")));
            System.out.println("Hovering over the 'Publisher' link...");
    ...
    @Test
    @Order(4)
    @DisplayName("Click the 'Publisher' link")
    void clickPublisherLink() {
        // Act
        try {
            System.out.println("Clicking the 'Publisher' link...");
    ...
    void checkNavigationToWebpage() {
        // Arrange
        String expectedWebsite = "https://library.oapen.org/browse?type=publisher";
