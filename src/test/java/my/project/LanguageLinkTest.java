...
public class LanguageLinkTest {
    ...
    static void initializeFields() {
        System.out.println("\nRunning " + LanguageLinkTest.class.getSimpleName() + "...");
    ...
    @Test
    @Order(3)
    @DisplayName("Hover over the 'Language' link")
    void hoverOverLanguageLink() {
        // Act
        try {
            element = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Language")));
            System.out.println("Hovering over the 'Language' link...");
    ...
    @Test
    @Order(4)
    @DisplayName("Click the 'Language' link")
    void clickLanguageLink() {
        // Act
        try {
            System.out.println("Clicking the 'Language' link...");
    ...
    void checkNavigationToWebpage() {
        // Arrange
        String expectedWebsite = "https://library.oapen.org/browse?type=language";
